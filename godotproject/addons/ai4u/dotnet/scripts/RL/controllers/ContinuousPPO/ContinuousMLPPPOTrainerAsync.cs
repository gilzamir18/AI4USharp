...
public partial class ContinuousMLPPPOTrainerAsync : Trainer
{
	[Export]
	...
	private ContinuousMLPPPOMemory memory;
    ...
    private ContinuousMLPPPOAsyncSingleton asyncPlugin;
	...
	private void CollectData()
	{
		...
		float[] action = y.data<float>().ToArray();
